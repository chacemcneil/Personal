...
setwd("/work/cmcneil/Projects/Miscellaneous/Personal/D3")
source("D3Force.R")
...
# Graph object can also be specified as a list containing two data.frames for vertex (nodes) and edge (links) attributes
