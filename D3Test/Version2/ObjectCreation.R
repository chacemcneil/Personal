# Create work area
 ...
 blltmp <- data.table(x=380 + (0:3)*20,y=c(370,20,60,80),xvel=0,yvel=0,direc=0,grav=.1,fric=0,bnce=.96,mov=0,drag=0,type=c("rect"),
                      hw=cellwidth/2,hh=cellheight/2,r=cellheight/2, xs=NA, ys=NA,color="#FFBBFF",class="Bll")
