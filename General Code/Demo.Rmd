...
src <- "R&D Framework.pdf"
embed_file(src)

src2 <- "newfile.html"
embed_file(src2, filetype = "html")

src3 <- paste0("https://d33wubrfki0l68.cloudfront.net/",
              "d08c35bfe1ba68584788f5cdcad703d0c9d8263f/",
              "7969a/wp-content/uploads/2014/04/shiny.png")
embed_file(src3, filetype = "png", width = "50px", height = "60px")
...
# if(interactive()) {
    ggplotly(
      ggplot(clock[Hour == 3 & Minute %in% 30:32]) +
        geom_line(aes(Sec_Hnd_x*.9, Sec_Hnd_y*.9), col = "red") +
        geom_line(aes(Min_Hnd_x, Min_Hnd_y)) +
        geom_line(aes(Hr_Hnd_x*.6, Hr_Hnd_y*.6)) +
...
img <- paste0("data:image/png;base64,",
              base64Encode(readBin(src, "raw", 1e5), "txt") )
```

<table><tr><td style="width: 20%;"><a href=""><image src="`r img`" style="width: 50px; height: 50px;"/></td><td>
